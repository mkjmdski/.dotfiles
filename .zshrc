...
export ZSH="/home/mlodzikos/.oh-my-zsh"
export SHELL_CONFIG=$(dirname $ZSH/shell-config)
...
for binary in docker docker-compose yarn vault terraform minikube helm kubectl; do
